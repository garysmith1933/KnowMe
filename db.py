...
def seed():
    with db_conn.cursor() as cur:
      ...
      questions = [
          ...
          {"title":'What is my favorite anime?', "option1": 'Steins Gate', "option2": 'My Hero Academia', "option3": 'Death Note', "answer": 'Attack On Titan'},
          ...
          {"title":'What is my favorite movie?', "option1": 'The Truman Show', "option2": 'Sonic the Hedgehog 2', "option3": 'Coming to America', "answer": "The Matrix"},
